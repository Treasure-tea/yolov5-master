...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "中餐检测与营养分析"))
        self.label_4.setText(_translate("mainWindow", "中餐检测与营养分析"))
        ...
        self.label_8.setText(_translate("mainWindow", "标记框宽"))#帧间延时
        self.checkBox.setText(_translate("mainWindow", "启用"))
        self.label_11.setText(_translate("mainWindow", "菜品统计与营养分析"))#结果统计
        self.label_6.setText(_translate("mainWindow", "检测"))
        self.label_28.setText(_translate("mainWindow", "detect"))
